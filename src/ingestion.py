...
_ROSTER = [
    {
        ...
        "drug_class": "Sedative-hypnotic (Z-drug)",
        "mechanism": "Boosts GABA, the brain's main calming signal, at the GABA-A receptor - the same site benzodiazepines act on - slowing brain activity to bring on sleep.",
    ...
    },
    {
        ...
        "mechanism": "Blocks the enzyme that makes angiotensin II, a hormone that tightens blood vessels, so vessels relax and blood pressure falls.",
    ...
    },
    {
        ...
        "drug_class": "CNS stimulant (amphetamine)",
        "mechanism": "Increases dopamine and norepinephrine in the brain by triggering their release and blocking reuptake, which sharpens focus and alertness.",
    ...
    },
    {
        ...
        "mechanism": "Blocks the liver enzyme that makes cholesterol, so the liver pulls LDL cholesterol out of the blood.",
    ...
    },
    {
        ...
        "mechanism": "Blocks reuptake of serotonin so more of it stays active between brain cells, gradually lifting mood over several weeks.",
    ...
    },
    {
        ...
        "mechanism": "Stimulates beta-2 receptors in airway muscle, relaxing it and opening the airways within minutes.",
    ...
    },
    {
        ...
        "mechanism": "Cuts the liver's glucose production and makes muscle more sensitive to insulin, lowering blood sugar without causing lows on its own.",
    ...
    },
    {
        ...
        "mechanism": "Replaces the T4 hormone an underactive thyroid cannot make, restoring the body's metabolic pace.",
    ...
    },
    {
        ...
        "mechanism": "Blocks calcium entry into blood-vessel muscle, relaxing arteries and lowering blood pressure.",
    ...
    },
    {
        ...
        "mechanism": "Weakly activates opioid receptors and also raises serotonin and norepinephrine, two pain-dampening signals in the spinal cord.",
    ...
    },
    {
        ...
        "mechanism": "Blocks histamine H1 receptors so the allergy signal never lands; little of it crosses into the brain, so drowsiness is mild.",
    ...
    },
    {
        ...
        "mechanism": "Shuts down the stomach's acid pumps at their final step, sharply cutting acid production.",
    ...
    },
    {
        ...
        "mechanism": "Blocks vitamin K recycling, so the liver cannot finish making several clotting factors and blood clots more slowly.",
    ...
    },
    {
        ...
        "drug_class": "NSAID (nonsteroidal anti-inflammatory)",
        "mechanism": "Blocks the COX-1 and COX-2 enzymes that make prostaglandins, the chemicals behind pain, fever, and inflammation.",
    ...
    },
    {
        ...
        "mechanism": "Breaks bacterial cell-wall construction; the wall fails and the bacterium bursts. Has no effect on viruses.",
    ...
    },
    {
        ...
        "mechanism": "Boosts GABA at the GABA-A receptor, calming overall brain activity to bring on and maintain sleep.",
